...
public class ShortestPathL1 {
    ...
    private static void ShortestDistance(ArrayList<ArrayList<Integer>>adj, int s, int dest, int v){
        int pred[]= new int[v];
        int dist[]= new int[v];
        ...
        System.out.println("Minimum moves "+dist[dest]); //distance
    ...
    public static void main(String[] args) {
        ...
        ShortestDistance(adj,source,dest,v);
    }
}
